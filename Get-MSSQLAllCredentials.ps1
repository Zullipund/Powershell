# Need administrator permissions OS
# Need role sysadmin into SQL server
#--------------------------# Decript Passwords ##################
...
{	Add-Type -assembly System.Security;
	...
	if ('', 'MSSQLSERVER' -contains $iSQLInstName)
	{	[String]$InstName = 'MSSQLSERVER';
		[String]$SQLSrv = ${env:COMPUTERNAME};
	}
	else
	{	[String]$InstName = $iSQLInstName
		[String]$SQLSrv = "${env:COMPUTERNAME}\$InstName";
	}
...
#--------------------------#
# Export-ModuleMember -Function Get-MSSQLAllCredentials
# Export data to txt file
Get-MSSQLAllCredentials >> C:\Users\User\Desktop\cred.txt